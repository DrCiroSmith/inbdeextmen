                                            ...
                                            {rightOptions.map((rightOption, rightIndex) => {
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={`p-3 rounded-lg border-2 ${isRightSelected ? 'border-solid' : 'border-dashed'} flex items-center justify-between gap-3 min-h-[56px] transition-all cursor-pointer ${
                                                            isRightSelected
                                                                ? darkMode
