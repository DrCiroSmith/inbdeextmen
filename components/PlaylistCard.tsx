...
export const PlaylistCard: React.FC<PlaylistCardProps> = ({ playlist, onSelect, disabled }) => {
  return (
    <button
    ...
    >
      <div className="flex items-center justify-between w-full mb-4">
        ...
        <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Series {playlist.id}</span>
      </div>
